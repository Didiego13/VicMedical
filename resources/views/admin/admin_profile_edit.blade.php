            ...
            <form method="post" action="{{ route('store.profile')}}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  @error('name')
                  <span class="badge bg-danger" style="font-size:10pt;">el campo no debe estar vacío</span>
                  @enderror
                </div>
              </div>
              <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Número de Celular</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Foto de Perfil</label>
                <div class="col-sm-10">
